...
| :---------------------- | :---------------------- | :---------------------- |
| [Тестовое задание для аналитика данных в компанию Мамба](test_case_mamba) | Решение тестовых заданий для демонстрации навыков работы с SQL-запросами в рамках отклика на вакансию в компанию. | *Python (Jupiter Notebook), Pandas, SQL(PostgreSQL, SQLite3)*| 
| :---------------------- | :---------------------- | :---------------------- |
___
